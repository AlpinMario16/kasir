    ...
    <table style="border-bottom: dotted 2px; font-size: 14px;width: 240px;" >
        <?php
            ...
            <tr>
                ...
                <td  style="width: 10px; text-align:right;"><?= number_format($item['harga_jual'],0,",",".") ?></td>
                <td  style="width: 10px; text-align:right;" colspan="2"><?= number_format($item['jml_harga'],0,",",".") ?></td>
            </tr>
