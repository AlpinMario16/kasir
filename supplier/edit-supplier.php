                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telpon" class="form-control" id="telpon" placeholder="no telpon supplier" pattern="[0-9]{5,}" title="minimal 5 angka" value="<?= $supplier['telpon'] ?>" required>
                                </div>
                                <div class="form-group">
