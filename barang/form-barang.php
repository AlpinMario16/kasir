        ...
        <div class="row">
          ...
          <div class="col-lg-8 mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="harga_jual" class="form-control" id="harga_jual" value="<?= $msg != ''? $barang['harga_beli'] : null ?>"   placeholder="Rp 0" autocomplete="off"  required>
                        </div>
                        <div class="form-group">
                            <label for="stock_minimal"> Stock Minimal </label>
                            <input type="number" name="stock_minimal" class="form-control" id="stock_minimal"  <?= $msg != ''? $barang['stock_minimal'] : null ?>  placeholder="0" autocomplete="off"  required>
                        </div>
          </div>
          </div>
