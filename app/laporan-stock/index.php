        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="index.php?page=pembelian">Stock</a></li>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                ...
                <a href="index.php?page=laporan-stock&act=report" class="btn btn-sm btn-outline-primary float-right" target="_blank"><i class="fas fa-print"></i>Cetak</a>
            </div>
