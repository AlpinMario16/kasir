        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="index.php?page=costumer" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
          ...
          <div class="col-lg-6">
            <div class="card card-outline card-danger">
              <div class="card-header text-info">
                ...
                <h5><a href="index.php?page=laporan-stock" class="float-right" title="laporan stock"><i class="fas fa-arrow-right"></i></a></h5>
              </div>
              <table class="table">
                <tbody>
                  <?php
